      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>order</span>
               <h3>italian food</h3>
               <a href="menu.php" class="btn"style="font-size: 1.5rem; padding: 0.8rem 0.8rem;">see menus</a>
            </div>
            <div class="image">
...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=lasagna" class="box">
         <img src="images/lasagnaa.png" alt="">
         <h3>Lasagna</h3>
      </a>

      <a href="category.php?category=sandwiches" class="box">
...
<section class="products">
   ...
   <div class="more-btn">
   <a href="menu.php" class="btn" style="font-size: 2.5rem; padding: 1rem 1.8rem;">view all</a>
</div>
