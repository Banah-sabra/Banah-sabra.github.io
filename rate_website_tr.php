...
<head>
    ...
    <title>Deneyiminizi Değerlendirin</title>
...
<section class="form-container">
    <form action="" method="post">
        ...
        <textarea name="feedback" placeholder="Geri bildiriminizi ekleyin" required></textarea>
        
        <p> <a href="thanks_tr.php" class="btn-link">değerlendirme</a>.</p>
